...
const SideBar = () => {
  ...
  const getNavItemClasses = (menu: MenuItem) => {
    return classNames(
      "flex items-center cursor-pointer rounded w-full overflow-hidden my-1 p-7 transition duration-300",
      {
        ...
        "mr-2": toggleCollapse,
        "text-green-600": activeLink === menu.link,
  ...
  const sidebarClasses = classNames("h-screen w-[120px] mr-[3%] ml-[-1%] pt-20 pl-5 pb-4 bg-yellow-400 flex flex-col justify-between transition-all duration-300", {
    "w-80": !toggleCollapse,
    "w-20": toggleCollapse,
        ...
        <div className="flex flex-col items-start mt-10">
                ...
                <div className="mr-5">
                  {React.cloneElement(icon, {
                    className: classNames("w-22 h-23 flex-shrink-0", {
                      "text-green-600": activeLink === link,
                    }),
                  })}
                </div>
              </div>
          ...
          >
            <div className="ml-[-8px] mt-[-8px]">
              ...
              >
                <span className={classNames({ "text-green-600": activeLink === "/logOut" })}>
