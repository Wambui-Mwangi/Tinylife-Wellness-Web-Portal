...
<div className="flex flex-col ml-10 mt-10 font-nunito ">
      ...
      <div className="mt-10 flex flex-row gap-[5%] mb-10 ml-[33px]">
    
        <div className="bg-opacity-15 text-2xl bg-yellow-100 rounded-2xl shadow-2xl p-10  w-[700px] h-[370px] pt-20 ">
        ...
        <div className="bg-opacity-15 ml-[90px] bg-yellow-100 rounded-2xl shadow-2xl p-4 w-[700px] h-[370px] pt-20">
          <h4 className="text-2xl">
...
The map highlights the different wards in Nairobi and their case details. The level of exposure is subject to change  over time as the variables we considered also change
      ...
      <div className="bg-opacity-15 bg-green-800 text-white rounded-2xl shadow-2xl p-4  w-[800px] h-[350px] ml-[20%] mt-5 pt-20 ">
        <h4 className="text-2xl">
