...
//   ]);
//   const getMarkerColor = (percentage: any) => {
...
//     const markerColor : any = `#${intensityHex}0000`;
  
//     return markerColor;
//   };

//   useEffect(() => {
//     const updatedLocations = leadPoisoningLocations.map((location) => {
//       const markerColor = getMarkerColor(location.percentage);
...
//             iconSize: [25, 41],
//             iconAnchor: [12, 41],
//             html: `<div style="background-color: ${location.markerColor}; width: 20px; height: 41px; border-radius:30px; border-bottom-left-radius: 5px; border-bottom-right-radius: 190px;"></div>`,
//             popupAnchor: [0, -30],
//           });
